...
from model_transfer import resnet34,resnet50,resnet101
...
if __name__ == '__main__':
       ...
       # data = GOU_QI_DATA("/bak4t/back8t/v1/yangdataset/large_dataset/GS/new_data/", transform=None)
        ...
        train_data = GOU_QI_DATA("/bak4t/back8t/v1/yangdataset/large_dataset/selected_channel_datasets_119/",transform=None)
        train_loader = DataLoader(train_data, batch_size=64, num_workers=4, shuffle=True)
       
        test_data = GOU_QI_DATA("/bak4t/back8t/v1/yangdataset/large_dataset/selected_channel_datasets_119_test/", transform=None)
       ...
       # model_weight_path = "./resNet34.pth"
        ...
        net = resnet50(num_classes=5,inputchannel=119)
