...
class MobileNetV2_AutoSlim(MyNetwork):
    def __init__(self, cfg=None, num_classes=1000, dropout=0.2):
        super(MobileNetV2_AutoSlim, self).__init__()
        ...
        for t, c, n, s in interverted_residual_setting:
            ...
            for i in range(n):
                if i == 0:
                    self.features.append(block(input_channel, output_channel, s, expand_ratio=t1[count]))
                else:
